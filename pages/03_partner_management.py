...
st.set_page_config(layout="wide", page_title="Partner Mgmt")
database.init_db()
...
# CSS Theme
st.markdown("""<style>.stApp {background-image: url("https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?q=80&w=2070&auto=format&fit=crop"); background-attachment: fixed; background-size: cover;} .block-container {background: rgba(255, 255, 255, 0.92); padding: 2rem; border-radius: 20px;} .partner-card {background:white; padding:15px; border-left:6px solid #1e3a8a; border-radius:10px; box-shadow:0px 4px 10px rgba(0,0,0,0.1); margin-bottom:12px;}</style>""", unsafe_allow_html=True)
